...
namespace MeltySynth
{
    ...
    public sealed class SoundFont
    {
        ...
        /// </summary>
        public ReadOnlySpan<SampleHeader> SampleHeaders => sampleHeaders;

        /// <summary>
        /// The presets of the SoundFont.
        /// </summary>
        public ReadOnlySpan<Preset> Presets => presets;

        /// <summary>
        /// The instruments of the SoundFont.
        /// </summary>
        public ReadOnlySpan<Instrument> Instruments => instruments;
